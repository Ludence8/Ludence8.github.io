...
&nbsp;중첩된 포인터를 이용한 SMRAM 오염은 CommBuffer를 통해 값을 받고, 또 CommBuffer에 값을 저장할 때 이중 포인터를 사용하는 과정에서 생기는 문제를 의미한다. 아래 예제는 [CVE-2023-5058](https://www.binarly.io/advisories/brly-dva-2023-026) 사례로, 후지쯔 펌웨어, 또는 레노버 Yoga Slim 7 Pro에 들어간 UEFI에 발생한 취약점이다.
```C
