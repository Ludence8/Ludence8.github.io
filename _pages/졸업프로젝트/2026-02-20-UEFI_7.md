...
|__Varnode.getDescendants()__|X|Iterator<PcodeOp>|해당 Varnode 값을 입력으로 사용하는 모든 P-Code를 가져오는 함수|
...
|__Varnode.getDef()__|X|PcodeOp|해당 Varnode를 정의한 P-Code 연산을 반환하는 함수|

## 탐지 스크립트 구현
&nbsp;이를 기반으로 위 로직을 가지고 프로토타입 형태의 코드를 짰다.
[다운로드 링크](https://raw.githubusercontent.com/Ludence8/Ludence8.github.io/refs/heads/main/downloads/SmmCalloutHunter.java)
(코드가 너무 길어 다운로드 링크로 대체한다.)
&nbsp;(기본적인 Ghidra 스크립트 문법 및 구성은 [여기](https://blog.naver.com/PostList.naver?blogId=yooom7)를 참고하였다.)
